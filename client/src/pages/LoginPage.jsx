...
const productDetailContent = {
  ...
  polibot: {
    ...
    plans: [
      { title: '스타터', price: '39,000원 / 월', badge: '상담 시작', features: ['상담/추천 100회', '지식 업로드 기본', '가상계좌 월 단위'] },
      { title: '베이직', price: '99,000원 / 월', badge: '추천', featured: true, features: ['상담/추천 500회', '고객별 히스토리', '추천 근거 정리'] },
      { title: '프로', price: '290,000원 / 월', badge: '팀 운영', features: ['상담/추천 2,000회', '팀 단위 운영', '우선 지원'] }
    ]
  },
  infludex: {
